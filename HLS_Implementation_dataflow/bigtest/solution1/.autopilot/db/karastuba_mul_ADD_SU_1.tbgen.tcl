set moduleName karastuba_mul_ADD_SU_1
set isTopModule 0
...
set C_modelName {karastuba_mul_ADD_SU.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ z0_tmp_bits_read int 32 regular  }
	{ z0_digits_data_V int 64 regular {array 32 { 1 3 } 1 1 }  }
	{ z2_tmp_bits_read int 32 regular  }
	{ z2_digits_data_V int 64 regular {array 32 { 1 3 } 1 1 }  }
	{ cross_mul_tmp_bits_read int 32 regular  }
	{ cross_mul_digits_data_V int 64 regular {array 32 { 1 3 } 1 1 }  }
...
set portList { 
	...
	{ z0_digits_data_V_address0 sc_out sc_lv 5 signal 1 } 
	...
	{ z2_digits_data_V_address0 sc_out sc_lv 5 signal 3 } 
	...
	{ lhs_digits_data_V_address0 sc_out sc_lv 5 signal 7 } 
	...
	{ rhs_digits_data_V_address0 sc_out sc_lv 5 signal 9 } 
	...
	{ res_digits_data_V_address0 sc_out sc_lv 6 signal 11 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5"],
		...
		"Port" : [
			...
			{"Name" : "z0_digits_data_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_CAT_I_I_I_O_1_fu_428", "Port" : "x0_digits_data_V"}]},
			...
			{"Name" : "z2_digits_data_V", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "grp_CAT_I_I_I_O_1_fu_428", "Port" : "x2_digits_data_V"}]},
	...
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_CAT_I_I_I_O_1_fu_428", "Parent" : "0",
		"CDFG" : "CAT_I_I_I_O_1",
		"Protocol" : "ap_ctrl_hs",
	...
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.karastuba_mul_mulsc4_U80", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "446", "Max" : "578"}
	, {"Name" : "Interval", "Min" : "446", "Max" : "578"}
]}
...
set Spec2ImplPortList { 
	...
	z0_digits_data_V { ap_memory {  { z0_digits_data_V_address0 mem_address 1 5 }  { z0_digits_data_V_ce0 mem_ce 1 1 }  { z0_digits_data_V_q0 mem_dout 0 64 } } }
	z2_tmp_bits_read { ap_none {  { z2_tmp_bits_read in_data 0 32 } } }
	z2_digits_data_V { ap_memory {  { z2_digits_data_V_address0 mem_address 1 5 }  { z2_digits_data_V_ce0 mem_ce 1 1 }  { z2_digits_data_V_q0 mem_dout 0 64 } } }
	cross_mul_tmp_bits_read { ap_none {  { cross_mul_tmp_bits_read in_data 0 32 } } }
	cross_mul_digits_data_V { ap_memory {  { cross_mul_digits_data_V_address0 mem_address 1 5 }  { cross_mul_digits_data_V_ce0 mem_ce 1 1 }  { cross_mul_digits_data_V_q0 mem_dout 0 64 } } }
	...
	res_digits_data_V { ap_memory {  { res_digits_data_V_address0 mem_address 1 6 }  { res_digits_data_V_ce0 mem_ce 1 1 }  { res_digits_data_V_we0 mem_we 1 1 }  { res_digits_data_V_d0 mem_din 1 64 } } }
}
