...
set C_modelArgList {
	...
	{ w_digits_data_V int 64 regular {array 16 { 2 3 } 1 1 }  }
}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.karastuba_mul_mulbkb_U5", "Parent" : "0"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "356", "Max" : "410"}
	, {"Name" : "Interval", "Min" : "356", "Max" : "410"}
]}
...
set Spec2ImplPortList { 
	...
	w_digits_data_V { ap_memory {  { w_digits_data_V_address0 mem_address 1 4 }  { w_digits_data_V_ce0 mem_ce 1 1 }  { w_digits_data_V_we0 mem_we 1 1 }  { w_digits_data_V_d0 mem_din 1 64 }  { w_digits_data_V_q0 mem_dout 0 64 } } }
}
