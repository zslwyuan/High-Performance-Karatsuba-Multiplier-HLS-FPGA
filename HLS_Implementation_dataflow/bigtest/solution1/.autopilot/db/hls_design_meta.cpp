...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("hs_input_V_TDATA", 64, hls_in, 0, "axis", "in_data", 1),
	Port_Property("res_output_V_TDATA", 64, hls_out, 1, "axis", "out_data", 1),
	Port_Property("hs_input_V_TVALID", 1, hls_in, 0, "axis", "in_vld", 1),
	Port_Property("hs_input_V_TREADY", 1, hls_out, 0, "axis", "in_acc", 1),
	Port_Property("res_output_V_TVALID", 1, hls_out, 1, "axis", "out_vld", 1),
	Port_Property("res_output_V_TREADY", 1, hls_in, 1, "axis", "out_acc", 1),
};
const char* HLS_Design_Meta::dut_name = "karastuba_mul";
