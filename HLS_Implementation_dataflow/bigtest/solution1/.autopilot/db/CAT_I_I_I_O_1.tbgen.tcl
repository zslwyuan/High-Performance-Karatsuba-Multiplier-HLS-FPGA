...
set portList { 
	...
	{ x1_tmp_bits_read sc_in sc_lv 32 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x1_tmp_bits_read", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "x1_tmp_bits_read", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	x1_tmp_bits_read { ap_none {  { x1_tmp_bits_read in_data 0 32 } } }
	...
	w_digits_data_V { ap_memory {  { w_digits_data_V_address0 mem_address 1 6 }  { w_digits_data_V_ce0 mem_ce 1 1 }  { w_digits_data_V_we0 mem_we 1 1 }  { w_digits_data_V_d0 mem_din 1 64 }  { w_digits_data_V_q0 mem_dout 0 64 } } }
}
