...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { cross_mul_digits_data_V_address0 { O 6 vector } cross_mul_digits_data_V_ce0 { O 1 bit } cross_mul_digits_data_V_we0 { O 1 bit } cross_mul_digits_data_V_d0 { O 64 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    id 110 \
    name cross_mul_tmp_bits \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_cross_mul_tmp_bits \
    op interface \
    ports { cross_mul_tmp_bits { O 32 vector } cross_mul_tmp_bits_ap_vld { O 1 bit } } \
} "
}
