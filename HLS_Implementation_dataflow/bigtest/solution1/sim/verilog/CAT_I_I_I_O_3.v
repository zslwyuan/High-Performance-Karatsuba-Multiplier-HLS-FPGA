...
reg[7:0] w_digits_data_address0;
...
reg   [7:0] j1_0_reg_186;
reg   [7:0] i2_0_reg_198;
reg   [1:0] tmp_1_reg_209;
reg   [8:0] j1_1_reg_221;
reg   [7:0] i3_0_reg_233;
reg   [31:0] reg_244;
...
wire   [7:0] i_44_fu_288_p2;
reg   [7:0] i_44_reg_496;
reg   [7:0] w_digits_data_addr_7_reg_506;
reg   [7:0] w_digits_data_addr_7_reg_506_pp0_iter1_reg;
reg   [31:0] x1_digits_data_load_reg_511;
wire   [7:0] j_7_fu_304_p2;
reg   [7:0] j_7_reg_517;
wire   [32:0] tmp_47_fu_321_p2;
reg   [32:0] tmp_47_reg_522;
wire   [31:0] add_ln182_fu_333_p2;
reg   [31:0] add_ln182_reg_527;
reg    ap_enable_reg_pp0_iter1;
wire   [7:0] w_digits_data_addr_6_reg_537;
wire    ap_CS_fsm_state10;
wire   [31:0] add_ln186_1_fu_370_p2;
reg   [31:0] add_ln186_1_reg_542;
...
wire   [7:0] i_45_fu_382_p2;
reg   [7:0] i_45_reg_551;
reg   [7:0] w_digits_data_addr_8_reg_561;
reg   [7:0] w_digits_data_addr_8_reg_561_pp1_iter1_reg;
reg   [31:0] x2_digits_data_load_reg_566;
wire   [8:0] j_8_fu_398_p2;
reg   [8:0] j_8_reg_572;
wire   [32:0] tmp_48_fu_415_p2;
reg   [32:0] tmp_48_reg_577;
...
reg   [7:0] ap_phi_mux_j1_0_phi_fu_190_p4;
wire    ap_block_pp0_stage0;
reg   [7:0] ap_phi_mux_i2_0_phi_fu_202_p4;
reg   [8:0] ap_phi_mux_j1_1_phi_fu_225_p4;
wire    ap_block_pp1_stage0;
reg   [7:0] ap_phi_mux_i3_0_phi_fu_237_p4;
wire   [63:0] zext_ln168_fu_254_p1;
wire   [63:0] zext_ln180_1_fu_294_p1;
wire   [63:0] zext_ln181_fu_299_p1;
wire   [63:0] zext_ln196_1_fu_388_p1;
wire   [63:0] zext_ln197_fu_393_p1;
wire    ap_block_pp0_stage1;
wire    ap_block_pp1_stage1;
wire   [32:0] zext_ln180_fu_314_p1;
wire   [32:0] zext_ln175_fu_310_p1;
wire   [31:0] zext_ln180_3_fu_317_p1;
wire   [31:0] add_ln182_1_fu_327_p2;
wire   [33:0] zext_ln180_4_fu_342_p1;
wire   [33:0] zext_ln180_2_fu_338_p1;
...
wire   [31:0] zext_ln196_3_fu_411_p1;
wire   [31:0] add_ln198_1_fu_421_p2;
wire   [33:0] zext_ln196_4_fu_436_p1;
wire   [33:0] zext_ln196_2_fu_432_p1;
wire   [33:0] tmp_46_fu_439_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln170_fu_265_p2 == 1'd1))) begin
        ...
        j1_0_reg_186 <= j_7_reg_517;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln191_reg_547 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        j1_1_reg_221 <= j_8_reg_572;
    end else if ((1'b1 == ap_CS_fsm_state13)) begin
        j1_1_reg_221 <= 9'd128;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln191_reg_547_pp1_iter1_reg == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage1) & (1'b0 == ap_block_pp1_stage1_11001))) begin
        tmp_1_reg_209 <= {{tmp_46_fu_439_p2[33:32]}};
    end else if ((1'b1 == ap_CS_fsm_state13)) begin
        tmp_1_reg_209 <= 2'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln175_reg_492 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        tmp_47_reg_522 <= tmp_47_fu_321_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state12)) begin
        add_ln186_1_reg_542 <= add_ln186_1_fu_370_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln191_reg_547 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ...
        tmp_48_reg_577 <= tmp_48_fu_415_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_44_reg_496 <= i_44_fu_288_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        i_45_reg_551 <= i_45_fu_382_p2;
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        w_digits_data_addr_7_reg_506_pp0_iter1_reg <= w_digits_data_addr_7_reg_506;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln175_fu_282_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        w_digits_data_addr_7_reg_506 <= zext_ln181_fu_299_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln191_fu_376_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        w_digits_data_addr_8_reg_561 <= zext_ln197_fu_393_p1;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln170_fu_265_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        zext_ln170_reg_477[7 : 0] <= zext_ln170_fu_277_p1[7 : 0];
    end
end
...
always @ (*) begin
    if (((icmp_ln175_reg_492 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_mux_i2_0_phi_fu_202_p4 = i_44_reg_496;
    end else begin
...
always @ (*) begin
    if (((icmp_ln191_reg_547 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_phi_mux_i3_0_phi_fu_237_p4 = i_45_reg_551;
    end else begin
...
always @ (*) begin
    if (((icmp_ln175_reg_492 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ap_phi_mux_j1_0_phi_fu_190_p4 = j_7_reg_517;
    end else begin
...
always @ (*) begin
    if (((icmp_ln191_reg_547 == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        ap_phi_mux_j1_1_phi_fu_225_p4 = j_8_reg_572;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage1))) begin
        w_digits_data_address0 = w_digits_data_addr_8_reg_561_pp1_iter1_reg;
        ...
        w_digits_data_address0 = w_digits_data_addr_6_reg_537;
    end else if ((1'b1 == ap_CS_fsm_state10)) begin
        w_digits_data_address0 = 64'd192;
    end else if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        w_digits_data_address0 = w_digits_data_addr_7_reg_506_pp0_iter1_reg;
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage1) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage1))) begin
        ...
        w_digits_data_d0 = add_ln186_1_reg_542;
    end else if (((1'b0 == ap_block_pp0_stage1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
assign add_ln182_1_fu_327_p2 = (reg_244 + zext_ln180_3_fu_317_p1);

assign add_ln182_fu_333_p2 = (add_ln182_1_fu_327_p2 + x1_digits_data_load_reg_511);

assign add_ln186_1_fu_370_p2 = (add_ln186_fu_365_p2 + reg_244);

assign add_ln186_fu_365_p2 = (zext_ln186_fu_361_p1 + x1_tmp_bits_read);

assign add_ln198_1_fu_421_p2 = (reg_244 + zext_ln196_3_fu_411_p1);

assign add_ln198_fu_427_p2 = (add_ln198_1_fu_421_p2 + x2_digits_data_load_reg_566);
...
assign i_44_fu_288_p2 = (ap_phi_mux_i2_0_phi_fu_202_p4 + 8'd1);

assign i_45_fu_382_p2 = (ap_phi_mux_i3_0_phi_fu_237_p4 + 8'd1);

assign i_fu_271_p2 = (i_0_reg_163 + 8'd1);

assign icmp_ln168_fu_248_p2 = ((j_0_reg_152 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln170_fu_265_p2 = ((i_0_reg_163 == 8'd128) ? 1'b1 : 1'b0);

assign icmp_ln175_fu_282_p2 = ((ap_phi_mux_i2_0_phi_fu_202_p4 == 8'd128) ? 1'b1 : 1'b0);

assign icmp_ln191_fu_376_p2 = ((ap_phi_mux_i3_0_phi_fu_237_p4 == 8'd128) ? 1'b1 : 1'b0);

assign j_7_fu_304_p2 = (j1_0_reg_186 + 8'd1);

assign j_8_fu_398_p2 = (j1_1_reg_221 + 9'd1);

assign j_fu_259_p2 = (j_0_reg_152 + 9'd1);

assign tmp_46_fu_439_p2 = (zext_ln196_4_fu_436_p1 + zext_ln196_2_fu_432_p1);

assign tmp_47_fu_321_p2 = (zext_ln180_fu_314_p1 + zext_ln175_fu_310_p1);

assign tmp_48_fu_415_p2 = (zext_ln196_fu_408_p1 + zext_ln191_fu_404_p1);

assign tmp_fu_345_p2 = (zext_ln180_4_fu_342_p1 + zext_ln180_2_fu_338_p1);

assign w_digits_data_addr_6_reg_537 = 64'd192;

assign x0_digits_data_address0 = zext_ln170_fu_277_p1;

assign x1_digits_data_address0 = zext_ln180_1_fu_294_p1;

assign x2_digits_data_address0 = zext_ln196_1_fu_388_p1;
...
assign zext_ln180_1_fu_294_p1 = ap_phi_mux_i2_0_phi_fu_202_p4;

assign zext_ln180_2_fu_338_p1 = reg_244;

assign zext_ln180_3_fu_317_p1 = tmp_0_reg_174;

assign zext_ln180_4_fu_342_p1 = tmp_47_reg_522;
...
assign zext_ln196_1_fu_388_p1 = ap_phi_mux_i3_0_phi_fu_237_p4;

assign zext_ln196_2_fu_432_p1 = reg_244;

assign zext_ln196_3_fu_411_p1 = tmp_1_reg_209;

assign zext_ln196_4_fu_436_p1 = tmp_48_reg_577;
...
always @ (posedge ap_clk) begin
    zext_ln170_reg_477[63:8] <= 56'b00000000000000000000000000000000000000000000000000000000;
end

endmodule //CAT_I_I_I_O_3
