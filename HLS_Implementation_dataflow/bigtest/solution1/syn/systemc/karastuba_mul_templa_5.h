...
struct karastuba_mul_templa_5 : public sc_module {
    ...
    sc_out< sc_lv<4> > lhs_digits_data_V_address1;
    ...
    sc_out< sc_lv<4> > rhs_digits_data_V_address1;
    ...
    karastuba_mul_temtde* z0_digits_data_V_U;
    karastuba_mul_temtde* z2_digits_data_V_U;
    karastuba_mul_temtde* cross_mul_digits_dat_U;
    karastuba_mul_temtde* inter_lhs_digits_dat_U;
    karastuba_mul_temtde* inter_rhs_digits_dat_U;
    ...
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_ap_start;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_ap_done;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_ap_continue;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_ap_idle;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_ap_ready;
    sc_signal< sc_lv<4> > karastuba_mul_MUL_st_2_U0_lhs_digits_data_V_address0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_lhs_digits_data_V_ce0;
    sc_signal< sc_lv<4> > karastuba_mul_MUL_st_2_U0_rhs_digits_data_V_address0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_rhs_digits_data_V_ce0;
    sc_signal< sc_lv<4> > karastuba_mul_MUL_st_2_U0_z0_digits_data_V_address0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_z0_digits_data_V_ce0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_z0_digits_data_V_we0;
    sc_signal< sc_lv<64> > karastuba_mul_MUL_st_2_U0_z0_digits_data_V_d0;
    sc_signal< sc_lv<4> > karastuba_mul_MUL_st_2_U0_z2_digits_data_V_address0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_z2_digits_data_V_ce0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_z2_digits_data_V_we0;
    sc_signal< sc_lv<64> > karastuba_mul_MUL_st_2_U0_z2_digits_data_V_d0;
    sc_signal< sc_lv<4> > karastuba_mul_MUL_st_2_U0_cross_mul_digits_dat_address0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_cross_mul_digits_dat_ce0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_cross_mul_digits_dat_we0;
    sc_signal< sc_lv<64> > karastuba_mul_MUL_st_2_U0_cross_mul_digits_dat_d0;
    sc_signal< sc_lv<4> > karastuba_mul_MUL_st_2_U0_inter_lhs_digits_dat_address0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_inter_lhs_digits_dat_ce0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_inter_lhs_digits_dat_we0;
    sc_signal< sc_lv<64> > karastuba_mul_MUL_st_2_U0_inter_lhs_digits_dat_d0;
    sc_signal< sc_lv<4> > karastuba_mul_MUL_st_2_U0_inter_rhs_digits_dat_address0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_inter_rhs_digits_dat_ce0;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_inter_rhs_digits_dat_we0;
    sc_signal< sc_lv<64> > karastuba_mul_MUL_st_2_U0_inter_rhs_digits_dat_d0;
    sc_signal< sc_lv<32> > karastuba_mul_MUL_st_2_U0_ap_return_0;
    sc_signal< sc_lv<32> > karastuba_mul_MUL_st_2_U0_ap_return_1;
    sc_signal< sc_lv<32> > karastuba_mul_MUL_st_2_U0_ap_return_2;
    sc_signal< sc_lv<32> > karastuba_mul_MUL_st_2_U0_ap_return_3;
    sc_signal< sc_lv<32> > karastuba_mul_MUL_st_2_U0_ap_return_4;
    ...
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_inter_rhs_digits_dat_full_n;
    ...
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_inter_lhs_digits_dat_full_n;
    ...
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_cross_mul_digits_dat_full_n;
    ...
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_z2_digits_data_V_full_n;
    ...
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_z0_digits_data_V_full_n;
    sc_signal< sc_logic > ap_sync_reg_channel_write_z0_digits_data_V;
    sc_signal< sc_logic > ap_sync_channel_write_z0_digits_data_V;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_ap_start;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_ap_done;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_ap_continue;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_ap_idle;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_ap_ready;
    sc_signal< sc_lv<4> > karastuba_mul_ADD_SU_2_U0_z0_digits_data_V_address0;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_z0_digits_data_V_ce0;
    sc_signal< sc_lv<4> > karastuba_mul_ADD_SU_2_U0_z2_digits_data_V_address0;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_z2_digits_data_V_ce0;
    sc_signal< sc_lv<4> > karastuba_mul_ADD_SU_2_U0_cross_mul_digits_data_V_address0;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_cross_mul_digits_data_V_ce0;
    sc_signal< sc_lv<4> > karastuba_mul_ADD_SU_2_U0_lhs_digits_data_V_address0;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_lhs_digits_data_V_ce0;
    sc_signal< sc_lv<4> > karastuba_mul_ADD_SU_2_U0_rhs_digits_data_V_address0;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_rhs_digits_data_V_ce0;
    sc_signal< sc_lv<32> > karastuba_mul_ADD_SU_2_U0_res_tmp_bits;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_res_tmp_bits_ap_vld;
    sc_signal< sc_lv<5> > karastuba_mul_ADD_SU_2_U0_res_digits_data_V_address0;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_res_digits_data_V_ce0;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_res_digits_data_V_we0;
    sc_signal< sc_lv<64> > karastuba_mul_ADD_SU_2_U0_res_digits_data_V_d0;
    ...
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_start_full_n;
    sc_signal< sc_logic > karastuba_mul_MUL_st_2_U0_start_write;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_start_full_n;
    sc_signal< sc_logic > karastuba_mul_ADD_SU_2_U0_start_write;
    ...
    void thread_karastuba_mul_ADD_SU_2_U0_ap_continue();
    void thread_karastuba_mul_ADD_SU_2_U0_ap_start();
    void thread_karastuba_mul_ADD_SU_2_U0_start_full_n();
    void thread_karastuba_mul_ADD_SU_2_U0_start_write();
    void thread_karastuba_mul_MUL_st_2_U0_ap_continue();
    void thread_karastuba_mul_MUL_st_2_U0_ap_start();
    void thread_karastuba_mul_MUL_st_2_U0_cross_mul_digits_dat_full_n();
    void thread_karastuba_mul_MUL_st_2_U0_inter_lhs_digits_dat_full_n();
    void thread_karastuba_mul_MUL_st_2_U0_inter_rhs_digits_dat_full_n();
    void thread_karastuba_mul_MUL_st_2_U0_start_full_n();
    void thread_karastuba_mul_MUL_st_2_U0_start_write();
    void thread_karastuba_mul_MUL_st_2_U0_z0_digits_data_V_full_n();
    void thread_karastuba_mul_MUL_st_2_U0_z2_digits_data_V_full_n();
