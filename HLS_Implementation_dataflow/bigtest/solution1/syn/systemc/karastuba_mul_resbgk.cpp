...
void karastuba_mul_resbgk::proc_tptr() {
    if (reset.read() == SC_LOGIC_1) {
        tptr.write(0);
...
void karastuba_mul_resbgk::proc_count() {
    if (reset.read() == SC_LOGIC_1) {
        count.write(0);
...
void karastuba_mul_resbgk::proc_full_n() {
    if (reset.read() == SC_LOGIC_1) {
...
void karastuba_mul_resbgk::proc_empty_n() {
    if (reset.read() == SC_LOGIC_1) {
