...
// ==============================================================
#ifndef __karastuba_mul_mulsc4__HH__
#define __karastuba_mul_mulsc4__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(karastuba_mul_mulsc4) {
    ...
    SC_CTOR(karastuba_mul_mulsc4):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
