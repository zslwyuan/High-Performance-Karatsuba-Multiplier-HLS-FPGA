...
set C_modelName {CAT_I_I_I_O.1}
set C_modelType { void 0 }
set C_modelArgList {
	{ x0_digits_data_V int 64 regular {array 32 { 1 3 } 1 1 }  }
	{ x1_tmp_bits_read int 7 regular  }
	{ x1_digits_data_V int 64 regular {array 32 { 1 3 } 1 1 }  }
	{ x2_digits_data_V int 64 regular {array 32 { 1 3 } 1 1 }  }
	{ w_digits_data_V int 64 regular {array 64 { 2 2 } 1 1 }  }
}
...
set portList { 
	...
	{ x0_digits_data_V_address0 sc_out sc_lv 5 signal 0 } 
	...
	{ w_digits_data_V_address1 sc_out sc_lv 6 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "x0_digits_data_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "x0_digits_data_V", "role": "address0" }} , 
 	...
 	{ "name": "x1_digits_data_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "x1_digits_data_V", "role": "address0" }} , 
 	...
 	{ "name": "x2_digits_data_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "x2_digits_data_V", "role": "address0" }} , 
 	...
 	{ "name": "w_digits_data_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "w_digits_data_V", "role": "address0" }} , 
 	...
 	{ "name": "w_digits_data_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "w_digits_data_V", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	x0_digits_data_V { ap_memory {  { x0_digits_data_V_address0 mem_address 1 5 }  { x0_digits_data_V_ce0 mem_ce 1 1 }  { x0_digits_data_V_q0 mem_dout 0 64 } } }
	x1_tmp_bits_read { ap_none {  { x1_tmp_bits_read in_data 0 7 } } }
	x1_digits_data_V { ap_memory {  { x1_digits_data_V_address0 mem_address 1 5 }  { x1_digits_data_V_ce0 mem_ce 1 1 }  { x1_digits_data_V_q0 mem_dout 0 64 } } }
	x2_digits_data_V { ap_memory {  { x2_digits_data_V_address0 mem_address 1 5 }  { x2_digits_data_V_ce0 mem_ce 1 1 }  { x2_digits_data_V_q0 mem_dout 0 64 } } }
	w_digits_data_V { ap_memory {  { w_digits_data_V_address0 mem_address 1 6 }  { w_digits_data_V_ce0 mem_ce 1 1 }  { w_digits_data_V_we0 mem_we 1 1 }  { w_digits_data_V_d0 mem_din 1 64 }  { w_digits_data_V_q0 mem_dout 0 64 }  { w_digits_data_V_address1 MemPortADDR2 1 6 }  { w_digits_data_V_ce1 MemPortCE2 1 1 }  { w_digits_data_V_we1 MemPortWE2 1 1 }  { w_digits_data_V_d1 MemPortDIN2 1 64 }  { w_digits_data_V_q1 MemPortDOUT2 0 64 } } }
}
