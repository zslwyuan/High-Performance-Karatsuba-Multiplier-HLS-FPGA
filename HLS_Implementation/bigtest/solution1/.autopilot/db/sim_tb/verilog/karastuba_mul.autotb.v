...
`define AUTOTB_TVIN_hs_input  "./c.karastuba_mul.autotvin_hs_input.dat"
`define AUTOTB_TVIN_res_output  "./c.karastuba_mul.autotvin_res_output.dat"
`define AUTOTB_TVIN_hs_input_out_wrapc  "./rtl.karastuba_mul.autotvin_hs_input.dat"
`define AUTOTB_TVIN_res_output_out_wrapc  "./rtl.karastuba_mul.autotvin_res_output.dat"
`define AUTOTB_TVOUT_res_output  "./c.karastuba_mul.autotvout_res_output.dat"
`define AUTOTB_TVOUT_res_output_out_wrapc  "./impl_rtl.karastuba_mul.autotvout_res_output.dat"
module `AUTOTB_TOP;
...
initial begin : generate_AESL_ready_cnt_proc
    ...
    initial begin : finish_simulation
        ...
        @ (posedge AESL_clock);
        @ (posedge AESL_clock);
    fp1 = $fopen("./rtl.karastuba_mul.autotvout_res_output.dat", "r");
    fp2 = $fopen("./impl_rtl.karastuba_mul.autotvout_res_output.dat", "r");
    if(fp1 == 0)        // Failed to open file
        $display("Failed to open file \"./rtl.karastuba_mul.autotvout_res_output.dat\"!");
    else if(fp2 == 0)
        $display("Failed to open file \"./impl_rtl.karastuba_mul.autotvout_res_output.dat\"!");
    else begin
        $display("Comparing rtl.karastuba_mul.autotvout_res_output.dat with impl_rtl.karastuba_mul.autotvout_res_output.dat");
        post_check(fp1, fp2);
    end
    $fclose(fp1);
    $fclose(fp2);
...
begin
    ...
    `define STREAM_SIZE_IN_hs_input "./stream_size_in_hs_input.dat"
