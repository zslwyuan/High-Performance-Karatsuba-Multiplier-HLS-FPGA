...
set C_modelArgList {
	{ u_tmp_bits_read int 2 regular  }
	{ u_digits_data_V int 64 regular {array 8 { 1 3 } 1 1 }  }
	{ v_tmp_bits_read int 2 regular  }
	{ v_digits_data_V int 64 regular {array 8 { 1 3 } 1 1 }  }
	{ w_digits_data_V int 64 regular {array 16 { 2 2 } 1 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "u_tmp_bits_read", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "u_digits_data_V", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "v_tmp_bits_read", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
 	{ "Name" : "v_digits_data_V", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ap_ready sc_out sc_logic 1 ready -1 } 
	{ u_tmp_bits_read sc_in sc_lv 2 signal 0 } 
	{ u_digits_data_V_address0 sc_out sc_lv 3 signal 1 } 
	{ u_digits_data_V_ce0 sc_out sc_logic 1 signal 1 } 
	{ u_digits_data_V_q0 sc_in sc_lv 64 signal 1 } 
	{ v_tmp_bits_read sc_in sc_lv 2 signal 2 } 
	{ v_digits_data_V_address0 sc_out sc_lv 3 signal 3 } 
	{ v_digits_data_V_ce0 sc_out sc_logic 1 signal 3 } 
	{ v_digits_data_V_q0 sc_in sc_lv 64 signal 3 } 
	{ w_digits_data_V_address0 sc_out sc_lv 4 signal 4 } 
	...
	{ w_digits_data_V_address1 sc_out sc_lv 4 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ap_ready", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "ready", "bundle":{"name": "ap_ready", "role": "default" }} , 
 	{ "name": "u_tmp_bits_read", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "u_tmp_bits_read", "role": "default" }} , 
 	{ "name": "u_digits_data_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "u_digits_data_V", "role": "address0" }} , 
 	{ "name": "u_digits_data_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "u_digits_data_V", "role": "ce0" }} , 
 	{ "name": "u_digits_data_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "u_digits_data_V", "role": "q0" }} , 
 	{ "name": "v_tmp_bits_read", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "v_tmp_bits_read", "role": "default" }} , 
 	{ "name": "v_digits_data_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "v_digits_data_V", "role": "address0" }} , 
 	{ "name": "v_digits_data_V_ce0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "v_digits_data_V", "role": "ce0" }} , 
 	{ "name": "v_digits_data_V_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "v_digits_data_V", "role": "q0" }} , 
 	{ "name": "w_digits_data_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "w_digits_data_V", "role": "address0" }} , 
 	...
 	{ "name": "w_digits_data_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "w_digits_data_V", "role": "address1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "356", "Max" : "398"}
	, {"Name" : "Interval", "Min" : "356", "Max" : "398"}
]}
...
set Spec2ImplPortList { 
	u_tmp_bits_read { ap_none {  { u_tmp_bits_read in_data 0 2 } } }
	u_digits_data_V { ap_memory {  { u_digits_data_V_address0 mem_address 1 3 }  { u_digits_data_V_ce0 mem_ce 1 1 }  { u_digits_data_V_q0 mem_dout 0 64 } } }
	v_tmp_bits_read { ap_none {  { v_tmp_bits_read in_data 0 2 } } }
	v_digits_data_V { ap_memory {  { v_digits_data_V_address0 mem_address 1 3 }  { v_digits_data_V_ce0 mem_ce 1 1 }  { v_digits_data_V_q0 mem_dout 0 64 } } }
	w_digits_data_V { ap_memory {  { w_digits_data_V_address0 mem_address 1 4 }  { w_digits_data_V_ce0 mem_ce 1 1 }  { w_digits_data_V_we0 mem_we 1 1 }  { w_digits_data_V_d0 mem_din 1 64 }  { w_digits_data_V_q0 mem_dout 0 64 }  { w_digits_data_V_address1 MemPortADDR2 1 4 }  { w_digits_data_V_ce1 MemPortCE2 1 1 }  { w_digits_data_V_we1 MemPortWE2 1 1 }  { w_digits_data_V_d1 MemPortDIN2 1 64 }  { w_digits_data_V_q1 MemPortDOUT2 0 64 } } }
}
