...
set C_modelArgList {
	...
	{ cross_mul_digits_data_V int 64 regular {array 16 { 2 2 } 1 1 }  }
}
...
set portList { 
	...
	{ cross_mul_digits_data_V_address1 sc_out sc_lv 4 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "cross_mul_digits_data_V_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":4, "type": "signal", "bundle":{"name": "cross_mul_digits_data_V", "role": "address1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "379", "Max" : "421"}
	, {"Name" : "Interval", "Min" : "379", "Max" : "421"}
]}
...
set Spec2ImplPortList { 
	...
	cross_mul_digits_data_V { ap_memory {  { cross_mul_digits_data_V_address0 mem_address 1 4 }  { cross_mul_digits_data_V_ce0 mem_ce 1 1 }  { cross_mul_digits_data_V_we0 mem_we 1 1 }  { cross_mul_digits_data_V_d0 mem_din 1 64 }  { cross_mul_digits_data_V_q0 mem_dout 0 64 }  { cross_mul_digits_data_V_address1 MemPortADDR2 1 4 }  { cross_mul_digits_data_V_ce1 MemPortCE2 1 1 }  { cross_mul_digits_data_V_we1 MemPortWE2 1 1 }  { cross_mul_digits_data_V_d1 MemPortDIN2 1 64 }  { cross_mul_digits_data_V_q1 MemPortDOUT2 0 64 } } }
}
