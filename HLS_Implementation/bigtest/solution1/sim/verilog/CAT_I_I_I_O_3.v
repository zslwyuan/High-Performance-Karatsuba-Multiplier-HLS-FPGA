...
output  [7:0] w_digits_data_address1;
...
reg[7:0] w_digits_data_address1;
...
reg   [7:0] j1_0_reg_190;
reg   [7:0] i2_0_reg_201;
reg   [1:0] tmp_1_reg_212;
reg   [8:0] j1_1_reg_224;
reg   [7:0] i3_0_reg_235;
reg   [31:0] reg_246;
...
wire   [7:0] i_34_fu_291_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [7:0] w_digits_data_addr_7_reg_513;
reg   [7:0] w_digits_data_addr_7_reg_513_pp0_iter1_reg;
reg   [7:0] w_digits_data_addr_7_reg_513_pp0_iter2_reg;
reg   [7:0] w_digits_data_addr_7_reg_513_pp0_iter3_reg;
wire   [7:0] j_7_fu_307_p2;
...
wire   [7:0] w_digits_data_addr_6_reg_545;
...
wire   [7:0] i_35_fu_389_p2;
reg    ap_enable_reg_pp1_iter0;
reg   [7:0] w_digits_data_addr_8_reg_569;
reg   [7:0] w_digits_data_addr_8_reg_569_pp1_iter1_reg;
reg   [7:0] w_digits_data_addr_8_reg_569_pp1_iter2_reg;
reg   [7:0] w_digits_data_addr_8_reg_569_pp1_iter3_reg;
wire   [8:0] j_8_fu_405_p2;
...
wire   [63:0] zext_ln179_1_fu_297_p1;
wire   [63:0] zext_ln180_1_fu_302_p1;
wire   [63:0] zext_ln195_1_fu_395_p1;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (icmp_ln169_fu_268_p2 == 1'd1))) begin
        ...
        j1_0_reg_190 <= j_7_fu_307_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((icmp_ln190_fu_383_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        j1_1_reg_224 <= j_8_fu_405_p2;
    end else if ((1'b1 == ap_CS_fsm_state14)) begin
        j1_1_reg_224 <= 9'd128;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln190_reg_555_pp1_iter3_reg == 1'd0) & (ap_enable_reg_pp1_iter4 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        tmp_1_reg_212 <= trunc_ln7_reg_596;
    end else if ((1'b1 == ap_CS_fsm_state14)) begin
        tmp_1_reg_212 <= 2'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln190_reg_555_pp1_iter2_reg == 1'd0) & (ap_enable_reg_pp1_iter3 == 1'b1) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        trunc_ln7_reg_596 <= {{tmp_29_fu_435_p2[33:32]}};
    end
end
...
always @ (posedge ap_clk) begin
    if (((icmp_ln169_fu_268_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
        zext_ln169_reg_484[7 : 0] <= zext_ln169_fu_280_p1[7 : 0];
    end
end
...
always @ (*) begin
    if (((icmp_ln190_reg_555_pp1_iter3_reg == 1'd0) & (1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter4 == 1'b1))) begin
        ap_phi_mux_tmp_1_phi_fu_216_p4 = trunc_ln7_reg_596;
    end else begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp1_stage0) & (ap_enable_reg_pp1_iter4 == 1'b1))) begin
        ...
        w_digits_data_address1 = 64'd192;
...
assign i_34_fu_291_p2 = (i2_0_reg_201 + 8'd1);

assign i_35_fu_389_p2 = (i3_0_reg_235 + 8'd1);

assign i_fu_274_p2 = (i_0_reg_167 + 8'd1);

assign icmp_ln167_fu_251_p2 = ((j_0_reg_156 == 9'd256) ? 1'b1 : 1'b0);

assign icmp_ln169_fu_268_p2 = ((i_0_reg_167 == 8'd128) ? 1'b1 : 1'b0);

assign icmp_ln174_fu_285_p2 = ((i2_0_reg_201 == 8'd128) ? 1'b1 : 1'b0);

assign icmp_ln190_fu_383_p2 = ((i3_0_reg_235 == 8'd128) ? 1'b1 : 1'b0);

assign j_7_fu_307_p2 = (j1_0_reg_190 + 8'd1);

assign j_8_fu_405_p2 = (j1_1_reg_224 + 9'd1);

assign j_fu_262_p2 = (j_0_reg_156 + 9'd1);

assign sext_ln185_fu_373_p1 = $signed(add_ln185_fu_368_p2);

assign tmp_29_fu_435_p2 = (zext_ln196_2_fu_432_p1 + zext_ln190_fu_424_p1);

assign tmp_fu_337_p2 = (zext_ln180_2_fu_334_p1 + zext_ln174_fu_326_p1);

assign w_digits_data_addr_6_reg_545 = 64'd192;

assign x0_digits_data_address0 = zext_ln169_fu_280_p1;

assign x1_digits_data_address0 = zext_ln179_1_fu_297_p1;

assign x2_digits_data_address0 = zext_ln195_1_fu_395_p1;
...
assign zext_ln179_1_fu_297_p1 = i2_0_reg_201;
...
assign zext_ln195_1_fu_395_p1 = i3_0_reg_235;
...
always @ (posedge ap_clk) begin
    zext_ln169_reg_484[63:8] <= 56'b00000000000000000000000000000000000000000000000000000000;
end
