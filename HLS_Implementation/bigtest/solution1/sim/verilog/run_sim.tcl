...
if {[file isfile karastuba_mul.autotvin.dat]} {
	file delete -force karastuba_mul.autotvin.dat
}

if {[file isfile karastuba_mul.autotvout.dat]} {
	file delete -force karastuba_mul.autotvout.dat
}
