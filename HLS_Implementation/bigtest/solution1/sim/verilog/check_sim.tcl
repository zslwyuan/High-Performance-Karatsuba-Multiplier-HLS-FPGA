...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.karastuba_mul.autotvin_hs_input.dat"
         "c.karastuba_mul.autotvin_res_output.dat"
         "c.karastuba_mul.autotvout_res_output.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.karastuba_mul.autotvout_res_output.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
